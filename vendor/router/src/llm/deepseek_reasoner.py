...
PRICE_INPUT_CACHE_HIT  = Decimal("0.000000003625")  # $0.003625 / 1M (cache hit)
PRICE_INPUT_CACHE_MISS = Decimal("0.000000435000")  # $0.435000 / 1M (cache miss)
PRICE_OUTPUT           = Decimal("0.000000870000")  # $0.870000 / 1M (output)
