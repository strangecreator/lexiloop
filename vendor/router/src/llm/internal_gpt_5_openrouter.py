...
PRICE_INPUT_CACHE_HIT  = Decimal("0.00000125")   # $1.25 / 1M (cache hit)
PRICE_INPUT_CACHE_MISS = Decimal("0.00000125")   # $1.25 / 1M (cache miss)
PRICE_OUTPUT           = Decimal("0.00001000")   # $10.0 / 1M (output)
